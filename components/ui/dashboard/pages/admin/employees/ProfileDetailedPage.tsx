...
import CertificationCard from "../../client/caregivermanagement/components/CertificationCard";
import EducationCard from "../../client/caregivermanagement/components/EducationCard";
import TerminateConfirmModal from "../../client/caregivermanagement/components/TerminateConfirmModal";
...
const assistance = ["Exercise", "Eating and drinking assistance"];

const hobies = ["Reading", "Swimming", "Cooking"];

const languages = ["English", "French", "Mandarin"];

const others = ["Christian", "African-American", "Cooking"];
            ...
            <div className="flex flex-col gap-2">
              <div className="flex justify-between items-start">
                <div className="flex gap-2">
                  ...
                  <span className="rounded-2xl bg-[#30A674] px-2 py-1 text-white text-sm opacity-60">
                    Available
                  </span>
                </div>
                <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex gap-4">
                  {assistance.map((item, index) => (
                    <span
                      key={index}
                      className="border border-distlineColor rounded-2xl px-4 py-2"
                    >
                      {item}
                    </span>
                  ))}
